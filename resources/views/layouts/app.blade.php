...
<section class="section-sm">
  ...
  <div class="post-slider">
      <img src="{{asset('user_assets/images/post/post-10.jpg')}}" class="card-img-top" alt="post-thumb">
      <img src="{{asset('user_assets/images/post/post-1.jpg')}}" class="card-img-top" alt="post-thumb">
  </div>
  <div class="card-body">
      ...
      <li class="list-inline-item">
          <a href="author-single.html" class="card-meta-author">
          <img src="{{asset('user_assets/images/john-doe.jpg')}}" alt="John Doe">
          <span>John Doe</span>
          </a>
      </li>
      <li class="list-inline-item">
  ...
  <article class="card mb-4">
  <div class="post-slider">
      <img src="{{asset('user_assets/images/post/post-3.jpg')}}" class="card-img-top" alt="post-thumb">
  </div>
  <div class="card-body">
  ...
  <article class="card mb-4">
  <div class="post-slider">
      <img src="{{asset('user_assets/images/post/post-7.jpg')}}" class="card-img-top" alt="post-thumb">
  </div>
  ...
  <article class="card mb-4">
  <div class="post-slider">
      <img src="{{asset('user_assets/images/post/post-8.jpg')}}" class="card-img-top" alt="post-thumb">
      <img src="{{asset('user_assets/images/post/post-9.jpg')}}" class="card-img-top" alt="post-thumb">
  </div>
  <div class="card-body">
      <h3 class="mb-3"><a class="post-title" href="post-details.html">How To Make Cupcakes and Cashmere Recipe At Home</a></h3>
      <ul class="card-meta list-inline">
  ...
  <div class="widget widget-author">
    ...
    <div class="media align-items-center">
      <div class="mr-3">
        <img class="widget-author-image" src="{{asset('user_assets/images/john-doe.jpg')}}">
      </div>
    ...
    <div class="media align-items-center">
      <div class="mr-3">
        <img class="widget-author-image" src="{{asset('user_assets/images/kate-stone.jpg')}}">
      </div>
      <div class="media-body">
    ...
    <div class="media align-items-center">
      <div class="mr-3">
        <img class="widget-author-image" src="{{asset('user_assets/images/john-doe.jpg')}}" alt="John Doe">
      </div>
      <div class="media-body">
...
<footer class="footer">
  ...
  <!-- Main Script -->
  <script src="{{asset('user_assets/js/script.js')}}"></script></body>
</html>
