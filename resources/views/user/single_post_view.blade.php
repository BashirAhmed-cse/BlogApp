      ...
      <div class=" col-lg-9   mb-5 mb-lg-0">
        <article>
          <div class="post-slider mb-4">
            <img src="{{asset('post_thumnails/'.$posts->thumbnail)}}" class="card-img" alt="post-thumb">
          </div>
          ...
          <ul class="card-meta my-3 list-inline">
            ...
            <li class="list-inline-item">
              <ul class="card-meta-tag list-inline">
                Category: <span class="text-primary">{{$posts->category_name}}</span>
              </ul>
            </li>
          </ul>
          <div class="content"><p>{{$posts->description}}</p>
          </div>
        </article>
